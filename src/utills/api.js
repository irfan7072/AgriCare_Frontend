...
export const predictDisease = async (formData) => {
  try {
    const response = await axios.post(
      `${BASE_URL}/prediction-diseasae/predictdisease/`, // matches backend typo
      formData,
...
export const getPredictionInfo = async (predictionData) => {
  try {
    const response = await fetch(`${BASE_URL}/prediction-diseasae/get_info_ds/`, { // matches backend typo
      method: "POST",
      headers: { "Content-Type": "application/json" },
